...
function initProjectModal() {
    ...
    const projectData = {
        'branding-1': {
            title: 'Фирменный стиль БК «БИВНИ»',
            desc: 'Разработка полного фирменного стиля для бойцовского клуба «БИВНИ». Создание логотипа, цветовой палитры, фирменной графики и иконографии. Дизайн рекламных материалов: плакаты, шоперы, баннеры. Интеграция QR-маркетинга в офлайн-точки контакта, а также разработка мерча для участников клуба.',
            tags: ['Брендинг', 'Айдентика', 'Мерч', 'QR-маркетинг'],
            images: [
        ...
        'branding-2': {
            title: 'Логотип турслета «Кремень»',
            desc: 'Разработка логотипа для мужского туристического слёта «Кремень». Брутальный, рубленый стиль, передающий силу и характер бренда. Иконография, паттерны для экипировки и мерча, рекомендации по нанесению на текстиль.',
            tags: ['Логотип', 'Иллюстрация', 'Туризм'],
            images: [
        ...
        'branding-3': {
            title: 'Логотип бара «Шот Кат»',
            desc: 'Создание логотипа для бара «Шот Кат», ориентированного на творческое сообщество дизайнеров. Неформальный, дерзкий подход с отсылками к дизайнерской культуре. Дополнительно разработаны: меню, коастеры, вывеска и элементы интерьера.',
            tags: ['Логотип', 'HoReCa', 'Айдентика'],
            images: [
        ...
        'web-1': {
            title: 'Сайт автофестиваля ASF AutoSpirit Fest',
            desc: 'Дизайн и разработка сайта для автофестиваля AutoSpirit Fest. Динамичный, атмосферный интерфейс с акцентом на автомобили и motorsport-культуру. Программа мероприятия, участники, фотогалерея, онлайн-покупка билетов.',
            tags: ['Веб-дизайн', 'UI/UX', 'Авто'],
            images: [
        ...
        'web-2': {
            title: 'Сайт фитнес клуба XLEVEL',
            desc: 'Разработка сайта фитнес клуба XLEVEL. Чистый, мотивирующий интерфейс с акцентом на результат. Полное расписание занятий, раздел тренеров, тарифные планы, онлайн-запись. Адаптивный дизайн для всех устройств.',
            tags: ['Веб-дизайн', 'Фитнес', 'Figma'],
            images: [
        ...
        'web-3': {
            title: 'Сайт базы отдыха «Лосиная берлога»',
            desc: 'Сайт базы отдыха «Лосиная берлога» с уклоном в мистическую атмосферу мультсериала «Гравити Фолз». Тайные символы, интерактивные пасхалки, атмосферные иллюстрации. Бронирование номеров, интерактивная карта территории.',
            tags: ['Веб-дизайн', 'Концепт', 'Иллюстрация'],
            images: [
        ...
        'media-1': {
            title: 'Интерактивная выставка Witch Road',
            desc: 'Разработка концепции и визуального оформления интерактивной выставки «Witch Road» в стилистике вселенной Marvel. Кинематографичные переходы между зонами, AR-элементы, иммерсивная среда для посетителей. Дизайн пространственных решений и навигации.',
            tags: ['Концепт', 'Marvel', 'Выставка', 'AR'],
            images: [
        ...
        'media-2': {
            title: 'Короткометражный фильм «В полной темноте»',
            desc: 'Короткометражный фильм, снятый в полной темноте. История ослепшего художника и его музы, рассказанная через экспериментальную работу со светом, звуком и визуальным повествованием. Пост-продакшн, цветокоррекция и саунд-дизайн.',
            tags: ['Кино', 'Эксперимент', 'Пост-продакшн'],
            images: [
        ...
        'media-3': {
            title: 'Робот-киноконсьерж ВИЖН',
            desc: 'Разработка концепции робота-киноконсьержа «ВИЖН» для кинотеатра. Дизайн внешнего вида, анимация движений и жестов, интерфейс взаимодействия с посетителями. Создание 3D-прототипа и анимационного презентационного ролика.',
            tags: ['Робототехника', '3D', 'Концепт', 'Анимация'],
            images: [
